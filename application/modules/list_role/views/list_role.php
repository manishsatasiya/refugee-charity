...
<script type="text/javascript" src="<?php print base_url(); ?>js/grid/list_role.js"></script>
		...
		<div class="portlet light">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green-sharp bold uppercase"><?php echo $this->lang->line('role_p_heading'); ?></span>
				</div>
				<div class="actions">
					<a href="list_role/add" class="btn green" data-target="#myModal" data-toggle="modal"><?php echo $this->lang->line('add_new'); ?> <i class="fa fa-plus"></i></a>
				</div>
			</div>
