	...
	<div class="col-md-6">
		<div class="portlet light bg-inverse">
			<div class="portlet-title">
				<div class="caption font-purple-plum">
					<i class="icon-speech font-purple-plum"></i>
					<span class="caption-subject bold uppercase"> <?php echo $this->lang->line('location_of_refugee'); ?></span>
				</div>
				<div class="actions">
...
<div class="row">
	<div class="col-md-6">
		...
		<div class="portlet light bg-inverse">
			...
			<div class="portlet-body">
				<div class="table-container">
					<table class="table table-striped table-bordered table-hover" id="grid_nationality">
						<thead>
							<tr role="row" class="heading">
								<th width="2%"><?php echo $this->lang->line('db_id'); ?></th>
