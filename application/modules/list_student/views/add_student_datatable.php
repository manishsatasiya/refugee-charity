...
<div class="modal-body">
	...
	<div class="row form-row">
		...
		<div class="col-md-6">
			...
			<div class="input_box_thin"><?php print form_dropdown('gender',array(''=> 'Select Gender','M'=> 'Male','F'=>'Female'),($rowdata)?$rowdata->gender:$this->session->flashdata('gender'),'id="gender" class="select2 form-control"'); ?></div>
			</div>
		</div>	
		<div class="clear"></div>
	</div>
	<div class="row form-row">
		...
		<div class="col-md-4">
		  	<div class="form-group">
			<div class="form_label2">Section Time</div>
			<div class="input_box_thin" id="section_time"><?=$section_time?></div>
			</div>
		  </div>	
		<div class="clear"></div>
	</div>
