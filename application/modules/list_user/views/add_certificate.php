...
<div class="modal-body">
    ...
    <div class="row form-row">
		...
		<div class="col-md-3">
			<div class="form_label2"><?php print form_label('120 Hours', 'hours'); ?></div>
            <?php $checked = (isset($rowdata->hours) && $rowdata->hours == '1') ? true:false; ?>
			<div class="input_box_thin"><?php print form_checkbox(array('name' => 'hours', 'id' => 'hours', 'value' => '1', 'checked' => $checked)); ?></div>
		</div>
		<div class="col-md-3">
			<div class="form_label2"><?php print form_label('6 Hours Teaching', 'hours_teaching'); ?></div>
            <?php $checked = (isset($rowdata->hours_teaching) && $rowdata->hours_teaching == '1') ? true:false; ?>
			<div class="input_box_thin"><?php print form_checkbox(array('name' => 'hours_teaching', 'id' => 'hours_teaching', 'value' => '1', 'checked' => $checked)); ?></div>
		</div>
        <div class="col-md-12">
...
?>
<script>
check_qualification($("#certificate_id").val());
</script>