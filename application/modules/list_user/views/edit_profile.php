      ...
      <div class="tabbable tabs-left">
        ...
        <div class="tab-content">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <ul>
                    ...
                    <li class="line-mangr">
                      <div class="col-md-6">Line Manager: <?php echo $user_data->line_manager; ?></div>
                      <div class="col-md-6"> Office #:<?php echo $user_data->office_no; ?> | Desk #:<?php echo $user_data->desk; ?></div>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div class="info-box depart-info">
            <div class="row">
              <div class="col-md-12">
                <div class="sub-title">Staff Leaving Detail: </div>
                <ul>
                  <li>Last day of Work:
          ...
          <div class="tab-pane generaltab" id="tab2mypma">
            ...
            <div class="row" id="divToPrint" >
              ...
              <div class="col-md-12 " id="teacher_comment_main">
                ...
                <div style="min-height: 100px; border:solid 1px;float: left;width: 100%;">
                  <span id="current_teacher_comment"><p style="margin: 5px;"><?php echo (isset($user_data->user_pma_data->teacher_comment)) ? $user_data->user_pma_data->teacher_comment : ''; ?> </p></span>
                  <span id="current_teacher_comment_edit" style="display:none;float: left;width: 100%;margin: 5px;"> 
                    <?php print form_open('list_user/save_teacher_comment/teacher_comment/'.encrypt_decrypt('e', $user_data->user_unique_id).'', array('id' => '','name'=>'')) ."\r\n"; ?>
                      <textarea style="width: 614px;" name="teacher_comment"><?=isset($user_data->user_pma_data->teacher_comment) ? $user_data->user_pma_data->teacher_comment : ''; ?>
</textarea>
              ...
              <div class="col-md-6 ">
                ...
                <div style="min-height:100px; border:solid 1px; padding:5px;">
                  ...
                  <textarea style="width: 340px; height:50px;" name="teacher_strengths"><?=isset($user_data->user_pma_data->teacher_strengths) ? $user_data->user_pma_data->teacher_strengths : ''; ?>
</textarea>
                  <?php
                  }else{
                    echo isset($user_data->user_pma_data->teacher_strengths) ? "<p>".$user_data->user_pma_data->teacher_strengths."</p>" : '';
                  } ?>
                </div>
                <div class="clear"></div>
              </div>
              <div class="col-md-6 ">
                ...
                <div style="min-height:100px; border:solid 1px; padding:5px;">
                  <?php 
                  if(isset($user_data->user_pma_data->teacher_review_editable) && $user_data->user_pma_data->teacher_review_editable == 1 && in_array("add_pma_comment",$this->arrAction)) { ?>
                    <textarea style="width: 340px; height:50px;" name="teacher_improvements"><?=isset($user_data->user_pma_data->teacher_improvements) ? $user_data->user_pma_data->teacher_improvements : ''; ?>
</textarea>
                    <?php
                  }else{
                    echo isset($user_data->user_pma_data->teacher_improvements) ? "<p>".$user_data->user_pma_data->teacher_improvements."</p>" : '';
                  } ?>
                </div>
                <div class="clear"></div>
              </div>
              ...
              <div class="col-md-12 " id="line_manager_comment_main">
                ...
                <div style="min-height:100px; border:solid 1px;">
                  <span id="current_line_manager_comment"><p style="margin: 5px;"><?php echo isset($user_data->user_pma_data->line_manager_comment) ? $user_data->user_pma_data->line_manager_comment : ''; ?> </p></span>
                  <span id="current_line_manager_comment_edit" style="display:none;float: left;width: 100%;margin: 5px;"> 
                    <?php print form_open('list_user/save_teacher_comment/line_manager_comment/'.encrypt_decrypt('e', $user_data->user_unique_id).'', array('id' => '','name'=>'')) ."\r\n"; ?>
                      <textarea style="width: 614px; height:50px;" name="line_manager_comment"><?=isset($user_data->user_pma_data->line_manager_comment) ? $user_data->user_pma_data->line_manager_comment : ''; ?>
</textarea>
                      <input type="submit" class="btn" name="submit" value="Save">
                  </form>
                  </span>
              ...
              <div class="col-md-12 " id="line_manager_targets_main">
                ...
                <div style="min-height:100px; border:solid 1px;">
                  <span id="current_line_manager_targets"><p style="margin: 5px;"><?php echo isset($user_data->user_pma_data->line_manager_targets) ? $user_data->user_pma_data->line_manager_targets : ''; ?> </p></span>
                  <span id="current_line_manager_targets_edit" style="display:none;float: left;width: 100%;margin: 5px;"> 
                    <?php print form_open('list_user/save_teacher_comment/line_manager_targets/'.encrypt_decrypt('e', $user_data->user_unique_id).'', array('id' => '','name'=>'')) ."\r\n"; ?>
                      <textarea style="width: 614px; height:50px;" name="line_manager_targets"><?=isset($user_data->user_pma_data->line_manager_targets) ? $user_data->user_pma_data->line_manager_targets : ''; ?>
</textarea>
                      <input type="submit" class="btn" name="submit" value="Save">
                  </form>
                  </span>
        ...
        ?>
          ...
          <div class="edit-page tab-pane" id="tab2Edit">
            <ul class="nav nav-tabs" id="tab-01">
              ...
              <li><a href="#tab2Departure"><i class="fa fa-tachometer"></i> Staff Leaving </a></li>
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab2Edit2">
                ...
                <div class="grid info-box">
                  ...
                  <div class="grid-body ">
                    <div class="info-box">
                      <div class="row"> <?php print form_open_multipart('list_user/edit_profile/'.encrypt_decrypt('e', $user_data->user_unique_id).'/6', array('id' => 'edit_profile','name'=>'edit_profile')) ."\r\n"; ?>
						...
						?>
						  ...
						  //if($user_data->status == 20){ ?>
                            ...
                            <div class="tab-pane" id="tab2"> <br>
                              ...
                              <div class="row form-row">
                                <div class="col-md-3"> <?php print form_label('Office / Room #', 'office_no',array('class'=>'form-label')); ?> <?php print form_input(array('name' => 'office_no', 'id' => 'office_no', 'value' => ($user_data)?$user_data->office_no:$this->session->flashdata('office_no'), 'class' => 'form-control','placeholder' => 'Office no')); ?> </div>
                                <div class="col-md-3"> <?php print form_label('Desk #', 'desk',array('class'=>'form-label')); ?> <?php print form_input(array('name' => 'desk', 'id' => 'desk', 'value' => ($user_data)?$user_data->desk:$this->session->flashdata('desk'), 'class' => 'form-control','placeholder' => 'Desk')); ?> </div>
                                <div class="col-md-3"> <?php print form_label('Work Number', 'work_phone',array('class'=>'form-label')); ?> <?php print form_input(array('name' => 'work_phone', 'id' => 'work_phone', 'value' => ($user_data)?$user_data->work_phone:$this->session->flashdata('work_phone'), 'class' => 'form-control ','placeholder' => 'Work Number')); ?> </div>
                                <div class="col-md-3"> <?php print form_label('Ext', 'work_extention',array('class'=>'form-label')); ?> <?php print form_input(array('name' => 'work_extention', 'id' => 'work_extention', 'value' => ($user_data)?$user_data->work_extention:$this->session->flashdata('work_extention'), 'class' => 'form-control ','placeholder' => 'Ext')); ?> </div>
                              </div>
                              <div class="row form-row">
						  ...
						  $(document).ready(function(){
                            ...
                            <div class="tab-pane" id="tab4"> <br>
                              ...
                              <!--row 6.5 end-->
                              <div class="row form-row">
                                <div class="col-md-12"> <?php print form_label('Skpye interviews', '',array('class'=>'form-label')); ?> </div>
                                <div class="col-md-6">
                                  <?php print form_label('Interviewer 1', 'skp_interviewee1',array('class'=>'form-label')); ?> <?php print form_dropdown('skp_interviewee1',$other_user_interviewer_list,($user_data)?$user_data->skp_interviewee1:$this->session->flashdata('skp_interviewee1'),'id="skp_interviewee1" class=""'); ?> </div>
                                <div class="col-md-6">
                                  <?php print form_label('Interviewer 2', 'skp_interviewee2',array('class'=>'form-label')); ?> <?php print form_dropdown('skp_interviewee2',$other_user_interviewer_list,($user_data)?$user_data->skp_interviewee2:$this->session->flashdata('skp_interviewee2'),'id="skp_interviewee2" class=""'); ?> </div>
                                <div class="col-md-6"> 
                                  <?php print form_label('Document', 'skp_document',array('class'=>'form-label')); ?>
                                  <input type="file" name="skp_document" id="skp_document" class="form-control input-sm" accept="image/jpg|image/jpeg|image/png|application/pdf" placeholder="">
                                  <?php
                                  if(count($user_data) > 0 && !empty($user_data->skp_document) && file_exists($user_data->skp_document)){ ?>                                  
                                      <a href="<?php echo base_url().$user_data->skp_document; ?>" target="_blank">Download</a>
                                      <?php
                                  }
                                  ?>
                                </div>
                                <div class="col-md-6"> 
                                  <?php print form_label('Recommendation', 'skp_recommendation',array('class'=>'form-label')); ?>
                                  <?php print form_dropdown('skp_recommendation',$skp_recommendation_list,($user_data)?$user_data->skp_recommendation:$this->session->flashdata('skp_recommendation'),'id="skp_recommendation" class=""'); ?> </div>
                              </div>
                              <div class="row form-row">
                                <div class="col-md-6"> <?php print form_label('Strengths', 'skp_strengths',array('class'=>'form-label')); ?> <?php print form_textarea(array('name' => 'skp_strengths', 'id' => 'skp_strengths', 'value' => ($user_data)?$user_data->skp_strengths:$this->session->flashdata('skp_strengths'), 'class' => 'form-control ')); ?> </div>
                                <div class="col-md-6"> <?php print form_label('Weakness', 'skp_weakness',array('class'=>'form-label')); ?> <?php print form_textarea(array('name' => 'skp_weakness', 'id' => 'skp_weakness', 'value' => ($user_data)?$user_data->skp_weakness:$this->session->flashdata('skp_weakness'), 'class' => 'form-control ')); ?> </div>
                              </div>
    ...
    *********************************************** -->
              <div class="tab-pane generaltab" id="tab2Departure">
                <div class="info-box departure-info">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="sub-title">Staff Leaving Details</div>
                      <?php print form_open_multipart('list_user/edit_profile/'.encrypt_decrypt('e', $user_data->user_unique_id).'/', array('id' => '','name'=>'')) ."\r\n"; ?>
                      <ul>
                        <li>
                          <div class="col-md-5"><?php print form_label('Reason for Leaving', 'resignation_resons',array('class'=>'form-label')); ?></div>
                          <div class="col-md-5"> <?php print form_dropdown('resignation_resons',$leaving_reason_list,($user_data->staff_leaving_data)?$user_data->staff_leaving_data->resignation_resons:$this->session->flashdata('resignation_resons'),'id="resignation_resons" class="select2 form-control"'); ?> </div>
                        </li>
                        <li>
                          <div class="col-md-5"><?php print form_label('Leaving Notes', 'departure_notes',array('class'=>'form-label')); ?></div>
                          <div class="col-md-5"> <?php print form_textarea(array('name' => 'departure_notes', 'id' => 'departure_notes', 'value' => ($user_data->staff_leaving_data)?$user_data->staff_leaving_data->departure_notes:$this->session->flashdata('departure_notes'), 'class' => 'form-control ')); ?> </div>
                        </li>
                        <li>
                          <div class="col-md-5"><?php print form_label('Last day of work', 'last_day_of_work',array('class'=>'form-label')); ?></div>
                          <div class="col-md-5">
                            <div class="input-append success date col-md-10 col-lg-6 no-padding"> <?php print form_input(array('name' => 'last_day_of_work', 'id' => 'show_dp', 'value' => ($user_data->staff_leaving_data)?make_dp_date($user_data->staff_leaving_data->last_day_of_work):$this->session->flashdata('last_day_of_work'), 'class' => 'form-control ')); ?> <span class="add-on"><span class="arrow"></span><i class="fa fa-th"></i></span> </div>
                          </div>
                        </li>
                        <li>
                          <div class="col-md-5"><?php print form_label('Upload File', 'file',array('class'=>'form-label')); ?></div>
                          <div class="col-md-5"> <input type="file" name="file" id="file" class="form-control input-sm" accept="image/jpg|image/jpeg|image/png|application/pdf" placeholder=""> 
                            <?php
                            if (isset($user_data->staff_leaving_data->file) && $user_data->staff_leaving_data->file <> '' && file_exists($user_data->staff_leaving_data->file)) {
                              ?><br>
                              <a href="<?php echo base_url($user_data->staff_leaving_data->file); ?>" target="_blank">Download</a>
                              <?php
                            }
                            ?>
                          </div>
                  ...
                  <?php
                  if (isset($user_data->staff_leaving_data->updated_by_name) && $user_data->staff_leaving_data->updated_by_name <> '') {
                    echo '<p><br><b>Last updated by:</b> '.$user_data->staff_leaving_data->updated_by_name.' on '.make_dp_date($user_data->staff_leaving_data->updated_at).'</p>';
                    ?>
                    <?php
                  }
                  ?>
