...
<div class="row">
    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body form">
        	<?php print form_open_multipart('refugee/add/'.$id, array('id' => 'add_refugee','name'=>'add_refugee')) ."\r\n"; ?>
            <div class="form-body">
        	<?php
            ...
            <div class="row ">
                <div class="col-md-6">
                    ...
                    <?php print form_label($this->lang->line('date_of_data_entry'), 'date_of_data_entry',array('class'=>'control-label')); ?>
                    <?php print form_input(array('date_of_data_entry' => 'date_of_data_entry', 'id' => 'date_of_data_entry', 'value' => ($rowdata)?$rowdata->date_of_data_entry:$this->session->flashdata('date_of_data_entry'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row ">
                <div class="col-md-6">
                    ...
                    <?php print form_input(array('location_of_association' => 'location_of_association', 'id' => 'location_of_association', 'value' => ($rowdata)?$rowdata->location_of_association:$this->session->flashdata('location_of_association'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    <?php print form_label($this->lang->line('full_name'), 'full_name',array('class'=>'control-label')); ?>
                    <?php print form_input(array('full_name' => 'full_name', 'id' => 'full_name', 'value' => ($rowdata)?$rowdata->full_name:$this->session->flashdata('full_name'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
            </div>
            <div class="row ">
                <div class="col-md-6">
                    ...
                    <?php print form_input(array('age' => 'age', 'id' => 'age', 'value' => ($rowdata)?$rowdata->age:$this->session->flashdata('age'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    <?php print form_label($this->lang->line('gender'), 'gender',array('class'=>'control-label')); ?>
                    <?php print form_input(array('gender' => 'gender', 'id' => 'gender', 'value' => ($rowdata)?$rowdata->gender:$this->session->flashdata('gender'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
            </div>
            <div class="row ">
                ...
                <div class="col-md-6">
                    ...
                    <?php print form_input(array('nationality_id_no' => 'nationality_id_no', 'id' => 'nationality_id_no', 'value' => ($rowdata)?$rowdata->nationality_id_no:$this->session->flashdata('nationality_id_no'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
            </div>
            <div class="row ">
                <div class="col-md-6">
                    ...
                    <?php print form_input(array('un_id' => 'un_id', 'id' => 'un_id', 'value' => ($rowdata)?$rowdata->un_id:$this->session->flashdata('un_id'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    <?php print form_label($this->lang->line('marital_status'), 'marital_status',array('class'=>'control-label')); ?>
                    <?php print form_input(array('marital_status' => 'marital_status', 'id' => 'marital_status', 'value' => ($rowdata)?$rowdata->marital_status:$this->session->flashdata('marital_status'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
            </div>
            <div class="row ">
                <div class="col-md-6">
                    ...
                    <?php print form_input(array('previous_occupation' => 'previous_occupation', 'id' => 'previous_occupation', 'value' => ($rowdata)?$rowdata->previous_occupation:$this->session->flashdata('previous_occupation'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row ">
                <div class="col-md-6">
                    ...
                    <?php print form_input(array('what_skills_do_you_have_for_working' => 'what_skills_do_you_have_for_working', 'id' => 'what_skills_do_you_have_for_working', 'value' => ($rowdata)?$rowdata->what_skills_do_you_have_for_working:$this->session->flashdata('what_skills_do_you_have_for_working'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row ">
                <div class="col-md-6">
                    ...
                    <?php print form_input(array('if_yes_please_specify' => 'if_yes_please_specify', 'id' => 'if_yes_please_specify', 'value' => ($rowdata)?$rowdata->if_yes_please_specify:$this->session->flashdata('if_yes_please_specify'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    <?php print form_label($this->lang->line('where_do_you_live_location'), 'where_do_you_live_location',array('class'=>'control-label')); ?>
                    <?php print form_input(array('where_do_you_live_location' => 'where_do_you_live_location', 'id' => 'where_do_you_live_location', 'value' => ($rowdata)?$rowdata->where_do_you_live_location:$this->session->flashdata('where_do_you_live_location'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
            </div>
            <div class="row ">
                ...
                <div class="col-md-6">
                    ...
                    <?php print form_input(array('what_is_it_that_you_need_most' => 'what_is_it_that_you_need_most', 'id' => 'what_is_it_that_you_need_most', 'value' => ($rowdata)?$rowdata->what_is_it_that_you_need_most:$this->session->flashdata('what_is_it_that_you_need_most'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
            </div>
            <div class="row ">
                <div class="col-md-6">
                    ...
                    <?php print form_input(array('how_many_children_do_you_have' => 'how_many_children_do_you_have', 'id' => 'how_many_children_do_you_have', 'value' => ($rowdata)?$rowdata->how_many_children_do_you_have:$this->session->flashdata('how_many_children_do_you_have'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    <?php print form_label($this->lang->line('childrens_names_ages_genders'), 'childrens_names_ages_genders',array('class'=>'control-label')); ?>
                    <?php print form_input(array('childrens_names_ages_genders' => 'childrens_names_ages_genders', 'id' => 'childrens_names_ages_genders', 'value' => ($rowdata)?$rowdata->childrens_names_ages_genders:$this->session->flashdata('childrens_names_ages_genders'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
            </div>
            <div class="row ">
                <div class="col-md-6">
                    ...
                    <?php print form_input(array('other_family_members_names_ages_genders' => 'other_family_members_names_ages_genders', 'id' => 'other_family_members_names_ages_genders', 'value' => ($rowdata)?$rowdata->other_family_members_names_ages_genders:$this->session->flashdata('other_family_members_names_ages_genders'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <?php print form_input(array('contact_details_email_skype_whatsapp' => 'contact_details_email_skype_whatsapp', 'id' => 'contact_details_email_skype_whatsapp', 'value' => ($rowdata)?$rowdata->contact_details_email_skype_whatsapp:$this->session->flashdata('contact_details_email_skype_whatsapp'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
            </div>
            <div class="row ">
                <div class="col-md-6">
                    ...
                    <?php print form_input(array('name_administrator' => 'name_administrator', 'id' => 'name_administrator', 'value' => ($rowdata)?$rowdata->name_administrator:$this->session->flashdata('name_administrator'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row ">
                <div class="col-md-6">
                    ...
                    <?php print form_input(array('total_number_of_people_in_house' => 'total_number_of_people_in_house', 'id' => 'total_number_of_people_in_house', 'value' => ($rowdata)?$rowdata->total_number_of_people_in_house:$this->session->flashdata('total_number_of_people_in_house'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    <?php print form_label($this->lang->line('telephone_no'), 'telephone_no',array('class'=>'control-label')); ?>
                    <?php print form_input(array('telephone_no' => 'telephone_no', 'id' => 'telephone_no', 'value' => ($rowdata)?$rowdata->telephone_no:$this->session->flashdata('telephone_no'), 'class' => 'form-control ')); ?>
                     </div>
                </div>
            </div>
            <div class="row ">
